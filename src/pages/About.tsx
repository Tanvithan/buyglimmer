  ...
  return (
    <section id="about" className="max-w-[1400px] mx-auto pt-32 pb-16 md:pt-40 md:pb-32 px-4 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20 items-center">
      <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
        <h2 className="text-2xl md:text-5xl font-black tracking-tighter mb-6 md:mb-8 leading-tight">The Indumenti Vision</h2>
        <p className="text-[#94a3b8] text-base md:text-lg leading-relaxed mb-8 md:10">Founded in 2021, Indumenti represents the intersection of digital street culture and artisanal craftsmanship. We don't follow trends; we create the artifacts of tomorrow.</p>
