                  ...
                  <div className="flex justify-center gap-2 sm:gap-3">
                    {otp.map((digit, index) => (
                      <input
                        ...
                        className="w-10 h-12 sm:w-14 sm:h-16 bg-slate-700/50 border-2 border-slate-600 rounded-xl sm:rounded-2xl text-center text-white text-xl sm:text-2xl font-bold focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 transition-all shadow-lg"
                      />
                    ))}
                  </div>
